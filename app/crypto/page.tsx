...
interface MemecoinAsset extends BaseAsset {
  type: "memecoin";
  fullName: string;
  marketCap: string;
  volume24h: string;
...
type Asset = NFTAsset | MemecoinAsset;

// Define type for prediction
type Prediction = {
  assetId: string;
  direction: "up" | "down";
  timestamp: number;
            ...
            >
              ...
              <div className="p-5">
                <div className="flex items-center mb-4">
                  <div className="w-16 h-16 rounded-xl overflow-hidden mr-4 relative">
                    <Image
                  ...
                  {asset.type === "nft" ? (
                    <>
                      <div className="p-2 bg-emerald-50 rounded-lg">
                        ...
                        <div className="text-sm font-medium text-emerald-900">{asset.volume}</div>
                      </div>
                      <div className="p-2 bg-emerald-50 rounded-lg">
                        <div className="text-xs text-gray-500">Floor Price</div>
                        <div className="text-sm font-medium text-emerald-900">{asset.floorPrice}</div>
                      </div>
                    </>
                  ) : (
                    <>
                      <div className="p-2 bg-emerald-50 rounded-lg">
                        ...
                        <div className="text-sm font-medium text-emerald-900">{asset.marketCap}</div>
                      </div>
                      <div className="p-2 bg-emerald-50 rounded-lg">
                        <div className="text-xs text-gray-500">24h Volume</div>
                        <div className="text-sm font-medium text-emerald-900">{asset.volume24h}</div>
                      </div>
                    </>
                  )}
                </div>
